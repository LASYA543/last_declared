...
void travel :: admin_writedata(){
    tour s;
    LOG_INFO("Enter the Destination Code\nD-");
    cin>>s.admin_code;
    LOG_INFO("Enter the Destination Place\n");
    cin>>s.admin_place;
    LOG_INFO("Enter the Country of the Destination\n");
    cin>>s.admin_country;
    LOG_INFO("Enter the Number of days of the Trip\n");
    cin>>s.admin_days;
    LOG_INFO("Method of payment: \n");
    cin>>s.admin_payments;
    LOG_INFO("Enter the Cost of the trip: \n");
    cin>>s.admin_prices;
...
void travel :: admin_modify(){
    ...
    index=0;
   	...
   	for(indexj=0;indexj<index;indexj++){
	  		...
	  		switch(ch){
                case 1:
                    LOG_INFO("Destination Place: ");
                    cin>>s[indexj].admin_place;
                    LOG_INFO("Destination Country: ");
                    cin>>s[indexj].admin_country;
                    break;
                case 2:
                    LOG_INFO("No of days of Trip: ");
                    cin>>s[indexj].admin_days;
                    break;
                case 3:
                    LOG_INFO("Total Cost of the Trip: ");
